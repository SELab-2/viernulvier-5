...
const nl: Messages = {
  ...
  search: {
    ...
    blogPageSearchPlaceholder: 'Zoek blogs...',
    blogPageSubtitle: 'Lees de laatste verhalen en achtergrondartikelen.',
    fallbackUntitled: 'Zonder titel',
  ...
  production: {
    ...
    addGenrePlaceholder: 'Voeg genre toe...',
    addTagPlaceholder: 'Voeg tag toe...',
    chooseFilePlaceholder: 'Bestand kiezen',
    artistLabel: 'Artiest',
  ...
  event: {
    ...
    newLocationButton: '+ nieuwe locatie',
    newLocationNamePlaceholder: 'Naam',
    newLocationAddressPlaceholder: 'Adres',
    newLocationValidationError: 'Naam en adres zijn verplicht.',
    newLocationCreateError: 'Aanmaken van locatie is mislukt.',
    newLocationCreatingLabel: 'Bezig...',
    newLocationAddLabel: 'Locatie toevoegen',
  },
  auth: {
