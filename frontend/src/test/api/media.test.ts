...
describe('getPreferredHeroCropUrl', () => {
    ...
    it('returns the FE3_header url when present', () => {
        ...
        expect(getPreferredHeroCropUrl(crops)).toBe(`/api/v1/images/00000000-0000-0000-0000-0000000000010`)
    })

    it('falls back to FE3_boxed when FE3_header is missing', () => {
        const crops = [makeCrop('FE3_boxed'), makeCrop('banner')]
        expect(getPreferredHeroCropUrl(crops)).toBe('/api/v1/images/00000000-0000-0000-0000-000000000009')
    })
...
describe('getPreferredMediaCropUrl', () => {
    ...
    it('returns the FE3_boxed url when present', () => {
        ...
        expect(getPreferredMediaCropUrl(crops)).toBe('/api/v1/images/00000000-0000-0000-0000-000000000009')
    })

    it('falls back to FE3_header when FE3_boxed is missing', () => {
        const crops = [makeCrop('FE3_header'), makeCrop('banner')]
        expect(getPreferredMediaCropUrl(crops)).toBe('/api/v1/images/00000000-0000-0000-0000-0000000000010')
    })
