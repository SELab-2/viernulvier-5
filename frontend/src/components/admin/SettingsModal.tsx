...
function EditorsTab({ isVisible }: EditorsTabProps) {
    ...
    useEffect(() => {
        ...
        api.get<EditorsResponse>('/cms-users/editors')
            .then((response) => {
                if (!isActive) {
                    return
                }
    ...
    async function handleCreateSubmit(event: React.FormEvent<HTMLFormElement>) {
        ...
        try {
            const response = await api.post<{ data: EditorEntry }>('/cms-users/editors', {
    ...
    async function handleEditorSave() {
        ...
        try {
            const response = await api.patch<{ data: EditorEntry }>(`/cms-users/editors/${selectedEditor.id}`, {
    ...
    async function handlePasswordReset() {
        ...
        try {
            await api.patch(`/cms-users/editors/${selectedEditor.id}`, {
    ...
    async function handleDelete() {
        ...
        try {
            await api.delete(`/cms-users/editors/${selectedEditor.id}`)
            setState((current) => ({
                ...current,
