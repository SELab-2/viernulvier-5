...
describe('Spaces Routes', () => {
    ...
    it('GET /api/v1/archive/spaces should return 200', async () => {
        const response = await app.inject({ method: 'GET', url: '/api/v1/archive/spaces' })
    ...
    describe('PUT /api/v1/archive/spaces/:id', () => {
